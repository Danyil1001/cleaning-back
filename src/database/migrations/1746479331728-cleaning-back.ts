...
export class CleaningBack1746479331728 implements MigrationInterface {
    name = 'CleaningBack1746479331728'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "client_request" ("id" SERIAL NOT NULL, "clientName" character varying NOT NULL, "email" character varying NOT NULL, "address" character varying, "phone_number" character varying, "optionId" integer, CONSTRAINT "PK_0caba076958d8b3a59348cc3d03" PRIMARY KEY ("id"))`);
